...
public class Adapter_Search extends BaseAdapter {
    private Show_Search context;
    private int layout;
    private List<product> milkteaList;

    public Adapter_Search(Context context, int layout, List<product> milkteaList) {
        this.context = (Show_Search) context;
        this.layout = layout;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            ...
            vh = (Adapter_Search.ViewHolder) view.getTag();
        }
