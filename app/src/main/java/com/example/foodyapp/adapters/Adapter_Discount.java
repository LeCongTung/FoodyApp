...
public class Adapter_Discount extends BaseAdapter {
    private Layout_Home context;
    private int layout;
    private List<product> milkteaList;

    public Adapter_Discount(Context context, int layout, List<product> milkteaList) {
        this.context = (Layout_Home) context;
        this.layout = layout;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        vh.tvprice.setText("Giá: " + String.valueOf(mt.getPrice()-5000) + " VNĐ");
